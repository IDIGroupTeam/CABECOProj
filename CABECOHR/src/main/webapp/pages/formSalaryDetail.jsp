			...
			<table class="table">
				<tbody>
					...
					<tr>						
						...
						<td><form:input path="workedDay" class="form-control bfh-number" min="0.5" max="31" step="0.5" type="number" required="required" title="Chỉ nhập số ngày nếu tháng đó không làm đủ cả tháng. Và bắt buộc phải định nghĩa ngày công chuẩn trước để việc tính toán được chính sác"/></td>
						<td bgcolor="#FAFAFA">Giờ công bảo trì:</td>
						<td><form:input path="maketingSalary" class="form-control animated"  maxlength="12" /></td>
						<td>x ${salaryPerHour} </td><td></td>
					</tr>				 
					<tr>
