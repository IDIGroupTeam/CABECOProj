...
<title>CABECO - Quản lý lịch sử công tác</title>
<style>
.error-message {
	color: red;
	font-size: 90%;
...
<%-- 					<td bgcolor="#FAFAFA">Thuộc cty:(*)</td>
					...
					<td colspan="3"><form:input path="achievement" maxlength="32" class="form-control animated"/></td>		
				</tr>
				<tr>
					<td bgcolor="#FAFAFA">Nhận xét:</td>
					<td colspan="3"><form:textarea path="appraise" cols="64" maxlength="64" class="form-control animated"/></td>
				</tr>
			</tbody>
		</table>
